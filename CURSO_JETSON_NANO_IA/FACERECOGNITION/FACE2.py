...
donFace = face_recognition.load_image_file('/home/nano/MaskDetection/demoImages/known/Donald Trump.jpg')
donEncode=face_recognition.face_encodings(donFace)[0]

nancyFace = face_recognition.load_image_file('/home/nano/MaskDetection/demoImages/known/Nancy Pelosi.jpg')
...
testImage=face_recognition.load_image_file('/home/nano/MaskDetection/demoImages/unknown/u3.jpg')
